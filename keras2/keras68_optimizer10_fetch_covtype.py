# m05_pca_evr_실습10_fetch_covtype.py 복사
...
# ======================= 1. 기본출력 =============================
# lr: 0.1, 로스:0.1
# lr: 0.1, r2: -0.007055005473031173

# ======================= 1. 기본출력 =============================
# lr: 0.01, 로스:0.01
# lr: 0.01, r2: 0.12720881181292798

# ======================= 1. 기본출력 =============================
# 제일 좋다.
# lr: 0.005, 로스:0.005
# lr: 0.005, r2: 0.20280377553120732

# ======================= 1. 기본출력 =============================
# lr: 0.001, 로스:0.001
# lr: 0.001, r2: -0.4373092589276959

# ======================= 1. 기본출력 =============================
# lr: 0.0005, 로스:0.0005
# lr: 0.0005, r2: -0.7091412444173246

# ======================= 1. 기본출력 =============================
# lr: 0.0001, 로스:0.0001
# lr: 0.0001, r2: -0.2580797271398596
...
# print(x.shape, y.shape) # (569, 30) (569,)하면 알 수 있듯이
# 행은 모두 30개이다. 그래서 n=30개부터 시작한다.
...
# Trech=0.021, n=12, ACC:99.12% <- 여기까지 ACC: 99.12%까지 같으니까
# 30-12 = 18인 것처럼 하위 18개를 빼고 상위 칼럼 12개만 가지고 해도 ACC가 같다는 말이다.

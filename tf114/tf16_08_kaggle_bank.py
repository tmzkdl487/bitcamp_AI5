...
x_data = train_csv.drop(['Geography', 'Gender', 'CustomerId', 'Surname', 'Exited'], axis=1).values.astype('float32')
y_data = train_csv['Exited'].values.reshape(-1, 1).astype('float32')

# print(x.shape)  # (165034, 8)

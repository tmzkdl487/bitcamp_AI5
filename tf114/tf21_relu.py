...
# layer3 = tf.compat.v1.sigmoid(tf.compat.v1.matmul(layer2, w3) + b3)  
# layer3 = tf.compat.v1.nn.relu(tf.compat.v1.matmul(layer2, w3) + b3)       # relu
layer3 = tf.compat.v1.nn.selu(tf.compat.v1.matmul(layer2, w3) + b3)       # selu
# layer3 = tf.compat.v1.nn.leaky_relu(tf.compat.v1.matmul(layer2, w3) + b3)   # leaky_relu
# layer3 = tf.compat.v1.nn.elu(tf.compat.v1.matmul(layer2, w3) + b3)            # elu

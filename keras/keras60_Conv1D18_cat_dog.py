# keras59_LSTM18_kaggle_cat_dog.py 복사

# https://www.kaggle.com/competitions/dogs-vs-cats-redux-kernels-edition/overview
    
from tensorflow.keras.preprocessing.image import ImageDataGenerator
from tensorflow.keras.models import Sequential, load_model
from tensorflow.keras.layers import Dense, Conv2D, Flatten, Dropout, MaxPooling2D, BatchNormalization, Conv1D, MaxPool1D
...
# print(x_train.shape, x_test.shape)  # (18750, 102, 102, 3) (6250, 102, 102, 3)

# exit()

x_train = x_train.reshape(18750, 80, 80*3) 
x_test = x_test.reshape(6250, 80, 80*3) 

# print(x_train.shape, x_test.shape)  # (18750, 102, 306) (6250, 102, 306)
...
# 모델 Conv1D 
# 60_cat_dog_로스는 :  7.850681304931641 / ACC :  0.491 / 데이터 걸린시간 :  79.49 초 / 걸린시간 :  10.51 초
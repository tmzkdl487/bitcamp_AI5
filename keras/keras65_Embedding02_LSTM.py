...
from tensorflow.keras.layers import Dense, Dropout, Input, Conv2D, Flatten, MaxPooling2D, LSTM, Bidirectional
...
#2. LSTM 모델구성
model = Sequential()
model.add(LSTM(21, return_sequences=True, input_shape=(5, 1), activation='relu')) # timesteps, features
model.add(LSTM(20))

# keras30_MCP_save_10_fetch_covtype.py 복사
...
dense1 = Dense(512, name='ys1', activation='relu')(input1)  # 레이어 이름도 변경가능, 성능에는 영향을 안 미친다.
dense2 = Dense(256, name='ys2', activation='relu')(dense1)
...
# 로스는 :  [0.2355908304452896, 0.9064576029777527]
# ACC :  0.906

# 드롭아웃 하고 나서
# 로스는 :  [0.2754940986633301, 0.8916388154029846] / ACC :  0.892 / 걸린시간:  368.52 초
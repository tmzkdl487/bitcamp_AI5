...
x_train = x_train.reshape(18750, 102, 102*3)
x_test = x_test.reshape(6250, 102, 102*3)
...
#2. LSTM모델구성
model = Sequential()
model.add(LSTM(21, return_sequences=True, input_shape=(102, 102*3), activation='relu')) # timesteps, features
model.add(LSTM(20))
...
print("59_kaggle_cat_dog로스는 : ", loss[0])

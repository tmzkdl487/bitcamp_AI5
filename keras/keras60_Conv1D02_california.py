...
from tensorflow.keras.layers import Dense, Dropout, Input, Flatten, Conv1D, MaxPooling1D 
...
#2. 모델 구성
model = Sequential()
model.add(Conv1D(64, (3,3), activation='relu', input_shape=(2, 2, 2), padding='same'))

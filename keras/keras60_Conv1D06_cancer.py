...
#2. Conv1D 모델
model = Sequential()
model.add(Conv1D(10, kernel_size=2, input_shape=(15 , 2))) # timesteps, features
...
# 모델 Conv1D 
# 로스 :  0.054917141795158386 / ACC :  0.921 / acc 0.9210526315789473 / 걸린시간 :  7.78 초
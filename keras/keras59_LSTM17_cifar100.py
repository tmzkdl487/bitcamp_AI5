...
from tensorflow.keras.layers import Dense, Input, Conv2D, Flatten, Dropout, BatchNormalization, MaxPooling2D, LSTM 
...
model.fit(x_train, y_train, epochs=10, batch_size=513,
...
print("cifar100_로스는 : ", round(loss[0], 3))
...
# LSTM 모델 
# cifar100_로스는 :  0.01 / ACC :  0.99 / 걸린시간:  103.31 초

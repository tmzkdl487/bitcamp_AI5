...
# print(x_train.shape, x_test.shape)  # (180000, 100, 2) (20000, 100, 2)
...
#2. Conv1D 모델
model = Sequential()
model.add(Conv1D(10, kernel_size=2, input_shape=(100, 2))) # timesteps, features
...
# sample_submission_csv.to_csv(path + "sampleSubmission_캐글_산타_0801_1725.csv")
...
# 모델 Conv1D 
# kaggle_santander 로스는 :  0.0702 / kaggle_santander ACC :  0.91 / 걸린시간:  8.35 초

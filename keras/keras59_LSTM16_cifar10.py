# keras40_hamsu3_cifar10.py 복사

from tensorflow.keras.datasets import mnist, fashion_mnist, cifar10
from tensorflow.keras.models import Sequential, load_model, Model
from tensorflow.keras.layers import LSTM, Dense, Input, Conv2D, Flatten, Dropout, BatchNormalization, MaxPooling2D
...
# print(x_train.shape)    # (50000, 96, 32)
...
#2. LSTM모델구성
model = Sequential()
model.add(LSTM(21, return_sequences=True, input_shape=(96, 32), activation='relu')) # timesteps, features
model.add(LSTM(20))
...
# LSTM 모델 
# 59_cifar10_로스는 :  0.09000186622142792 / ACC :  0.9 / 걸린시간:  44.41 초
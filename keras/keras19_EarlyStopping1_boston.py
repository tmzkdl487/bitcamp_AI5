# kkeras18_overfit1.boston.py 복사함
...
es = EarlyStopping(
    monitor = 'val_loss',
    mode ='min',    # 모르면 auto / min, max, auto 3가지가 있다.
    patience = 10,   # 참을 수 있는 숫자.
    restore_best_weights=True,  # 가장 좋은 웨이트 값을 줘. 이걸 써주지 않으면 밑에 결과를 알려줌, 근데 안써서 더 결과가 좋을 수도 있음, True말고 끝긴지점으로 다른 말을 넣어서 해도 된다.
)

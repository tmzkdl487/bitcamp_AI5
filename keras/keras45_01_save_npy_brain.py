...
np.save(np_path + 'keras45_brain_01_x_train.npy' , arr=xy_train[0][0])
np.save(np_path + 'keras45_brain_01_y_train.npy' , arr=xy_train[0][1])
np.save(np_path + 'keras45_brain_01_x_test.npy' , arr=xy_test[0][0])
np.save(np_path + 'keras45_brain_01_y_test.npy' , arr=xy_test[0][1])

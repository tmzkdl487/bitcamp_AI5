...
from tensorflow.keras.layers import Dense, Dropout, Input, Conv2D, Flatten, MaxPooling2D, Conv1D, MaxPool1D  
...
#2. Conv1D 모델
model = Sequential()
model.add(Conv1D(10, kernel_size=2, input_shape=(4 , 2))) # timesteps, features
...
# sampleSubmission.to_csv(path + "sampleSubmission_0801_1658.csv")
...
# 모델 Conv1D 
# r2스코어 :  0.02365015855957109 / 로스 :  33154.63671875 / 걸린시간 :  3.03 초
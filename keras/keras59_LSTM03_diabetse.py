...
#2. LSTM모델구성
model = Sequential()
model.add(LSTM(21, return_sequences=True, input_shape=(10, 1), activation='relu')) # timesteps, features
model.add(LSTM(20))
...
# LSTM 돌린 것.
# 로스 :  6080.76708984375 / r2스코어 :  -0.012509727567830309 / 걸린시간 :  11.15 초
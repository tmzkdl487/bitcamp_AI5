...
#2. LSTM 모델구성
model = Sequential()
model.add(LSTM(21, return_sequences=True, input_shape=(13,1), activation='relu')) # timesteps, features
model.add(LSTM(20))
...
# LSTM 돌린 것.
# 로스 :  109.04876708984375 / r2스코어 :  -0.004575860271883503 / 걸린시간 :  6.91 초
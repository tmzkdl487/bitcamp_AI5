...
from tensorflow.keras.layers import Dense, Flatten, Dropout, Conv1D, MaxPooling1D, Conv1D, MaxPool1D 
...
# print(x_train.shape, x_test.shape)  # (2016, 80, 240) (504, 80, 240)
...
#2. 모델
# model = Sequential()
# model.add(Conv1D(128, (3, 3), activation='relu', input_shape=(80, 80, 3)))
...
# 모델 Conv1D 
# ACC :  0.113 / 데이터 걸린시간 :  5.89 초 / 걸린시간 :  15.0 초

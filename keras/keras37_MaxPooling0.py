...
#2. 모델
model = Sequential()
model.add(Conv2D(10, 3, input_shape=(28, 28, 1),    # 10 옆에 3이면 (3, 3)의 커널사이즈라는 뜻임.
                 strides=1,
                #  padding='same'
                #  padding='valid'    
                 ))  # 26, 26, 10
model.add(MaxPooling2D(pool_size=3 , padding='same'))   # 13, 13, 10
...
#  conv2d_1 (Conv2D)           (None, 4, 4, 9)           819

#  conv2d_2 (Conv2D)           (None, 3, 3, 8)           296

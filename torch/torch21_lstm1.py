# torch19_rnn_bidirectional.py 카피
...
class LSTM(nn.Module): 
    def __init__(self):
        ...
        # self.cell = nn.LSTM(1, 32, batch_first=True) <- 위에 cell구성이 이렇게 한 줄로 할 수 있음.
    ...
    def forward(self, x, h0, c0):
        ...
        x = x.contiguous()
        # x = x.reshape(-1, 3*32*2) # 2차원 데이터로 리쉐입
        x = x.view(-1, 3*32)  # <- 곱하기 2안해주면 bidirectional 따블인지 인식 못해.
        x = self.fc1(x)
...
print("=======================================")
print(y_predict)    # [[10.379416]]
print("=======================================")
print(y_predict[0]) # [10.379416]
print("=======================================")
print(f'{x_predict}의 예측값 : {y_predict[0][0]}') # [[ 8  9 10]]의 예측값 : 10.379416465759277

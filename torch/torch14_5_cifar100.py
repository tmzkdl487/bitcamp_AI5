...
train_dataset = CIFAR100(path, train=True, download=False, transform=transf)  
test_dataset = CIFAR100(path, train=False, download=False, transform=transf)
...
# 최종 Loss : 3.4829799976592626
# 최종 acc : 0.17462060702875398
...
# torch.Size([124, 13]) torch.Size([54, 13]) torch.Size([124, 1]) torch.Size([54, 1])

print(np.unique(y))               #  [0 1 2]
print(f"출력 뉴런 수(클래스 개수): {len(np.unique(y))}") # 3
...
model = Model(13, 3).to(DEVICE)    # 인풋, 아웃풋 정의

...
<<<<<<< HEAD
    ...
    for x, y in tqdm.tqdm(train_loader, desc=f'Epoch {epoch}', leave=True):
=======
    for x, y in tqdm.tqdm(train_loader, desc=f'Epoch {epoch}', leave=True): # <= 선생님이 tqdm을 여기에 해보라고 해서 해봄.

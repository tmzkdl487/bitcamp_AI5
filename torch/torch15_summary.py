...
# -> 이걸 쓰니까 다시 56, 56이 아니라 28, 28로 돌아옴. 안 쓰기로 함.

#### x_train/127.5 -1   # 얘의 값의 범위는? -1 ~ 1  # 정규화라기보다는 표준화에 가까워
...
# aaa = next(bbb)
# print(aaa)
# print(aaa[0].shape) # torch.Size([32, 1, 56, 56]) <- 배치크기, 채널수, 가로, 세로 / keras는 배치 크기, 채널 수, 높이, 너비
...
# model.summary()   # 텐서플로는 요거얌.
# Traceback (most recent call last):
#   File "c:\ai5\study\torch\torch15_summary.py", line 90, in <module>
#     model.summary()
#     ^^^^^^^^^^^^^
#   File "C:\Users\kim ji hye2\AppData\Local\anaconda3\envs\torch241\Lib\site-packages\torch\nn\modules\module.py", line 1729, in __getattr__
...
# 최종 Loss : 0.042530561862984616
# 최종 acc : 0.9877196485623003  
'''